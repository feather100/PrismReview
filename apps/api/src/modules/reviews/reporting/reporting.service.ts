...
export class ReportingService {
  ...
  private async buildReportFromDb(review: any, dbOpinions: any[]): Promise<ReportResponseDto> {
    ...
    const opinions = reportableOpinions.map((o) => {
      ...
      return { dimension: o.dimension, agentCode: role.code, agentName: role.name, riskLevel: o.riskLevel, issue: o.issue, recommendation: o.recommendation, confidenceScore: o.confidenceScore, score: o.score ?? null, status: o.status ?? 'accepted', resolutionReason: o.resolutionReason ?? null, passageRefs: o.passageRefs ?? [] };
    });
