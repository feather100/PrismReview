...
export class PromptServiceImpl implements PromptService {
  ...
  async composeForModerator(state: ReviewState): Promise<string> {
    ...
    return [
      ...
      `- "converge": reviewers have reached sufficient consensus → output final report (round≥2 需收敛信号：全员 agree 或 noNewArguments=true)`,
      ...
      '',
      '## Convergence Signals (T2, code-enforced)\n- round >= 2 \u65f6\uff0c\u6536\u655b\u5fc5\u987b\u6ee1\u8db3\u5176\u4e00\uff1a\u5168\u5458 agree\uff08opinions stance\uff09\uff0c\u6216 noNewArguments=true\n- noNewArguments\uff1a\u4ec5\u5f53\u672c\u8f6e\u672a\u63d0\u51fa\u76f8\u5bf9\u66f4\u65e9\u8f6e\u6b21\u771f\u6b63\u65b0\u7684\u8bba\u70b9\u65f6\u4e3a true\uff1b\u4e0d\u786e\u5b9a\u65f6 false\n\n## Output Format (STRICT JSON, no markdown, no explanation)',
      '{"decisionType":"converge","reasoning":"<1-2 sentences explaining why>","noNewArguments":true,"proposedTools":[]}',
      '',
